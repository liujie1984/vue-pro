<style lang="less">
	...
	.mix-top span{display: inline-block;}
	.mix-top-left{background-color: #fda946;height: 15px;width: 4px;margin: 0 8px 0 8px;}
	.mix-title{height: 20px;line-height: 20px;}
...
<template>
    ...
    <div v-for="mix in mix">
    	<div class="blank"></div>
    	<div class="mix-top">
    		<span class="mix-top-left"></span><span class="mix-title">{{mix.title}}</span><span class="mix-more" v-link="{ name: 'mix-more', params: { id: mix.group_id }}">更多></span>
    	</div>
